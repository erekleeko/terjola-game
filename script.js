...
// საწყისი კოორდინატები დაბრუნებულია!
...
function startGame() {
    ...
    if (nameInput.trim() === "") {
        // ალერტის მაგივრად ტექსტი ენთება
...
function loadQuestion() {
    ...
    // ვმალავთ წინა მინიშნებას ყოველ ახალ კითხვაზე
    document.getElementById('hint-display').style.display = 'none';

    // ეტაპის დასრულება ალერტის გარეშე!
    if (currentQuestionIndex >= levelQuestions.length) {
        ...
        // 2 წამში თავისით გადადის რუკაზე
        setTimeout(() => {
            showMapScreen();
        }, 2000);
        return;
...
function showHint() {
    ...
    // ალერტის მაგივრად ეკრანზე ჩნდება ტექსტი
